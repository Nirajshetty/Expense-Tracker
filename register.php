...
if(isset($_POST['sub']))
{
  $error= false;
  $e=$_POST['email'];
$query= "SELECT email FROM Credentials WHERE email='$e'";
...
$q="INSERT INTO Credentials (iname,email,uname,pwd) VALUES ('$n','$e','$n','$hashed')";
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="" method="post" >
					...
					<div class="container-login100-form-btn"  style="margin-left: 250px;">
						<button name="sub" class="login100-form-btn">
							Register
						</button>
					</div>
				</form>
